...
public class MovieRepository {
    ...
    private void populate() {
        ...
        movies.put(4, new Movie(4, "Chéri", 2009, "tt1179258"));
        ...
        movies.put(8, new Movie(8, "Julie & Julia", 2009, "tt1135503"));
        movies.put(9, new Movie(9, "Broken Embraces", 2009, "tt0913425"));
        ...
        movies.put(13, new Movie(13, "Coco Before Chanel", 2009, "tt1035736"));
        movies.put(14, new Movie(14, "The Breath", 2009, "tt1171701"));
        movies.put(15, new Movie(15, "Up", 2009, "tt1049413"));
        movies.put(16, new Movie(16, "Whiteout", 2009, "tt0365929"));
        movies.put(17, new Movie(17, "The Time Traveler's Wife", 2009, "tt0452694"));
        movies.put(18, new Movie(18, "Whatever Works", 2009, "tt1178663"));
        movies.put(19, new Movie(19, "A Woman in Berlin", 2008, "tt1035730"));
        ...
        movies.put(24, new Movie(24, "Angels & Demons", 2009, "tt0808151"));
        ...
        movies.put(54, new Movie(54, "World's Greatest Dad", 2009, "tt1262981"));
        ...
        movies.put(60, new Movie(60, "The Girl with the Dragon Tattoo", 2009, "tt1132620"));
        movies.put(61, new Movie(61, "Mary and Max", 2009, "tt0978762"));
        movies.put(62, new Movie(62, "The Limits of Control", 2009, "tt1135092"));
        movies.put(63, new Movie(63, "Sunshine Cleaning", 2008, "tt0862846"));
        movies.put(64, new Movie(64, "A Perfect Getaway", 2009, "tt0971209"));
        movies.put(65, new Movie(65, "My Sister's Keeper", 2009, "tt1078588"));
        movies.put(66, new Movie(66, "Winter in Wartime", 2008, "tt0795441"));
        ...
        movies.put(71, new Movie(71, "Taking Woodstock", 2009, "tt1127896"));
        ...
        movies.put(79, new Movie(79, "Before the Devil Knows You're Dead", 2007, "tt0292963"));
        ...
        movies.put(87, new Movie(87, "The Secret in Their Eyes", 2009, "tt1305806"));
        ...
        movies.put(93, new Movie(93, "Sunset Boulevard", 1950, "tt0043014"));
        movies.put(94, new Movie(94, "Network", 1976, "tt0074958"));
        movies.put(95, new Movie(95, "Vertigo", 1958, "tt0052357"));
        movies.put(96, new Movie(96, "Spring, Summer, Fall, Winter... and Spring", 2003, "tt0374546"));
        movies.put(97, new Movie(97, "Them!", 1954, "tt0047573"));
        movies.put(98, new Movie(98, "3-Iron", 2004, "tt0423866"));
        movies.put(99, new Movie(99, "A Moment to Remember", 2004, "tt0428870"));
        movies.put(100, new Movie(100, "The Bow", 2005, "tt0456470"));
        movies.put(101, new Movie(101, "Castaway on the Moon", 2009, "tt1499666"));
        movies.put(102, new Movie(102, "Wrong Rosary", 2009, "tt1366981"));
        movies.put(103, new Movie(103, "Daybreakers", 2009, "tt0433362"));
        movies.put(104, new Movie(104, "Dream", 2008, "tt1165253"));
        movies.put(105, new Movie(105, "Oldboy", 2003, "tt0364569"));
        movies.put(106, new Movie(106, "Cairo Time", 2009, "tt0896529"));
        movies.put(107, new Movie(107, "The Market: A Tale of Trade", 2008, "tt1286165"));
        movies.put(108, new Movie(108, "The Cove", 2009, "tt1313104"));
        movies.put(109, new Movie(109, "Tenderness", 2009, "tt0494864"));
        movies.put(110, new Movie(110, "Hachi: A Dog's Tale", 2009, "tt1028532"));
        movies.put(111, new Movie(111, "The Treasure of the Sierra Madre", 1948, "tt0040897"));
        movies.put(112, new Movie(112, "The Magnificent One", 1973, "tt0070354"));
        movies.put(113, new Movie(113, "The Party", 1968, "tt0063415"));
        movies.put(114, new Movie(114, "The Box", 2009, "tt0362478"));
        movies.put(115, new Movie(115, "Everybody's Fine", 2009, "tt0780511"));
        ...
        movies.put(119, new Movie(119, "Seven Samurai", 1954, "tt0047478"));
        movies.put(120, new Movie(120, "My Sassy Girl", 2001, "tt0293715"));
        movies.put(121, new Movie(121, "Samaritan Girl", 2004, "tt0397619"));
        movies.put(122, new Movie(122, "Dial M for Murder", 1954, "tt0046912"));
        movies.put(123, new Movie(123, "A Prophet", 2009, "tt1235166"));
        movies.put(124, new Movie(124, "The Vicious Kind", 2009, "tt1183921"));
        movies.put(125, new Movie(125, "Thirst", 2009, "tt0762073"));
        ...
        movies.put(130, new Movie(130, "Adventureland", 2009, "tt1091722"));
        ...
        movies.put(135, new Movie(135, "The Wild Bunch", 1969, "tt0065214"));
        movies.put(136, new Movie(136, "Jolly Life", 2009, "tt1523515"));
        ...
        movies.put(147, new Movie(147, "Fame", 2009, "tt1016075"));
        ...
        movies.put(155, new Movie(155, "The Twilight Saga: New Moon", 2009, "tt1259571"));
        ...
        movies.put(160, new Movie(160, "The Karamazovs", 2008, "tt1080716"));
        movies.put(161, new Movie(161, "Post Grad", 2009, "tt1142433"));
        movies.put(162, new Movie(162, "The Collector", 2009, "tt0844479"));
        movies.put(163, new Movie(163, "Children of Heaven", 1997, "tt0118849"));
        movies.put(164, new Movie(164, "Daisy", 2006, "tt0468704"));
        ...
        movies.put(168, new Movie(168, "The Apartment", 1996, "tt0115561"));
        movies.put(169, new Movie(169, "Brooklyn's Finest", 2009, "tt1210042"));
        ...
        movies.put(173, new Movie(173, "Love Me If You Dare", 2003, "tt0364517"));
        ...
        movies.put(181, new Movie(181, "Envy", 2009, "tt1512894"));
        movies.put(182, new Movie(182, "The White Ribbon", 2009, "tt1149362"));
        ...
        movies.put(192, new Movie(192, "Worlds Apart", 2008, "tt1065318"));
        ...
        movies.put(197, new Movie(197, "Slovenian Girl", 2009, "tt1224373"));
        movies.put(198, new Movie(198, "9:06", 2009, "tt1361326"));
        movies.put(199, new Movie(199, "The American Friend", 1977, "tt0075675"));
        ...
        movies.put(205, new Movie(205, "The Classic", 2003, "tt0348568"));
        movies.put(206, new Movie(206, "In the Electric Mist", 2009, "tt0910905"));
        ...
        movies.put(211, new Movie(211, "The Double Hour", 2009, "tt1379222"));
        ...
        movies.put(219, new Movie(219, "Autumn", 2008, "tt1330591"));
        movies.put(220, new Movie(220, "Tombstone", 1993, "tt0108358"));
        movies.put(221, new Movie(221, "The Unknown Woman", 2006, "tt0494271"));
        movies.put(222, new Movie(222, "I Love You Phillip Morris", 2010, "tt1045772"));
        movies.put(223, new Movie(223, "You Don't Know Jack", 2010, "tt1132623"));
        movies.put(224, new Movie(224, "Ex Drummer", 2007, "tt0812243"));
        movies.put(225, new Movie(225, "Ip Man", 2008, "tt1220719"));
        movies.put(226, new Movie(226, "Ip Man 2", 2010, "tt1386932"));
        ...
        movies.put(230, new Movie(230, "A Driver for Vera", 2004, "tt0416292"));
        movies.put(231, new Movie(231, "Romantic Comedy", 2010, "tt1587263"));
        ...
        movies.put(235, new Movie(235, "What Doesn't Kill You", 2008, "tt1133991"));
        movies.put(236, new Movie(236, "Paris 36", 2008, "tt0948535"));
        ...
        movies.put(239, new Movie(239, "Sin Nombre", 2009, "tt1127715"));
        movies.put(240, new Movie(240, "Eloïse", 2009, "tt1221188"));
        movies.put(241, new Movie(241, "Love in Another Language", 2009, "tt1513713"));
        ...
        movies.put(247, new Movie(247, "17 Again", 2009, "tt0974661"));
        movies.put(248, new Movie(248, "Couples Retreat", 2009, "tt1078940"));
        movies.put(249, new Movie(249, "He's Just Not That Into You", 2009, "tt1001508"));
        movies.put(250, new Movie(250, "Funny People", 2009, "tt1201167"));
        movies.put(251, new Movie(251, "The Invention of Lying", 2009, "tt1058017"));
        movies.put(252, new Movie(252, "Whip It", 2009, "tt1172233"));
        movies.put(253, new Movie(253, "Confessions of a Shopaholic", 2009, "tt1093908"));
        movies.put(254, new Movie(254, "Ghosts of Girlfriends Past", 2009, "tt0821640"));
        ...
        movies.get(71).getGenres().add(genres.get(1));
        movies.get(71).getGenres().add(genres.get(2));
        ...
        movies.get(130).getGenres().add(genres.get(1));
        movies.get(130).getGenres().add(genres.get(2));
        movies.get(130).getGenres().add(genres.get(3));
        ...
        movies.get(147).getGenres().add(genres.get(2));
        movies.get(147).getGenres().add(genres.get(3));
        ...
        movies.get(161).getGenres().add(genres.get(1));
        movies.get(161).getGenres().add(genres.get(3));
        ...
        movies.get(214).getGenres().add(genres.get(7));
        ...
        movies.get(247).getGenres().add(genres.get(1));
        movies.get(247).getGenres().add(genres.get(2));
        movies.get(247).getGenres().add(genres.get(17));
        movies.get(248).getGenres().add(genres.get(1));
        movies.get(249).getGenres().add(genres.get(1));
        movies.get(249).getGenres().add(genres.get(2));
        movies.get(249).getGenres().add(genres.get(3));
        movies.get(250).getGenres().add(genres.get(1));
        movies.get(250).getGenres().add(genres.get(2));
        movies.get(251).getGenres().add(genres.get(1));
        movies.get(251).getGenres().add(genres.get(3));
        movies.get(251).getGenres().add(genres.get(17));
        movies.get(252).getGenres().add(genres.get(1));
        movies.get(252).getGenres().add(genres.get(2));
        movies.get(253).getGenres().add(genres.get(1));
        movies.get(253).getGenres().add(genres.get(3));
        movies.get(254).getGenres().add(genres.get(1));
        movies.get(254).getGenres().add(genres.get(3));
        movies.get(254).getGenres().add(genres.get(17));
        movies.get(255).getGenres().add(genres.get(12));
        movies.get(255).getGenres().add(genres.get(11));
        movies.get(255).getGenres().add(genres.get(1));
        movies.get(255).getGenres().add(genres.get(13));
        movies.get(255).getGenres().add(genres.get(17));
        ...
        directors.put(10, new Director(10, "Pedro Almodóvar", "nm0000264"));
        ...
        directors.put(46, new Director(46, "Michael Mann", "nm0000520"));
        ...
        directors.put(53, new Director(53, "Christian Alvart", "nm0023355"));
        ...
        directors.put(59, new Director(59, "Andy De Emmony", "nm0214320"));
        ...
        directors.put(124, new Director(124, "Joe Wright", "nm0942504"));
        ...
        directors.put(190, new Director(190, "Zoe Cassavetes", "nm0144023"));
        ...
        directors.put(203, new Director(203, "Sam Taylor-Johnson", "nm0939993"));
        ...
        directors.put(208, new Director(208, "Giuseppe Tornatore", "nm0868153"));
        ...
        directors.put(212, new Director(212, "Koen Mortier", "nm0607831"));
        ...
        directors.put(217, new Director(217, "Pavel Chukhray", "nm0161056"));
        ...
        directors.put(225, new Director(225, "Jesús Garay", "nm0304879"));
        ...
        directors.put(233, new Director(233, "Ang Lee", "nm0000487"));
        directors.put(234, new Director(234, "Greg Mottola", "nm0609549"));
        directors.put(235, new Director(235, "Kevin Tancharoen", "nm1160495"));
        directors.put(236, new Director(236, "Vicky Jenson", "nm0421776"));
        directors.put(237, new Director(237, "Burr Steers", "nm0824223"));
        directors.put(238, new Director(238, "Peter Billingsley", "nm0082517"));
        directors.put(239, new Director(239, "Ken Kwapis", "nm0477129"));
        directors.put(240, new Director(240, "Judd Apatow", "nm0031976"));
        directors.put(241, new Director(241, "Mike Mitchell", "nm0593610"));
        directors.put(242, new Director(242, "Ricky Gervais", "nm0315041"));
        directors.put(243, new Director(243, "Matthew Robinson", "nm0732958"));
        directors.put(244, new Director(244, "Drew Barrymore", "nm0000106"));
        directors.put(245, new Director(245, "P.J. Hogan", "nm0389591"));
        ...
        movies.get(71).getDirectors().add(directors.get(233));
        ...
        movies.get(130).getDirectors().add(directors.get(234));
        ...
        movies.get(147).getDirectors().add(directors.get(235));
        ...
        movies.get(161).getDirectors().add(directors.get(236));
        ...
        movies.get(247).getDirectors().add(directors.get(237));
        movies.get(248).getDirectors().add(directors.get(238));
        movies.get(249).getDirectors().add(directors.get(239));
        movies.get(250).getDirectors().add(directors.get(240));
        movies.get(251).getDirectors().add(directors.get(242));
        movies.get(251).getDirectors().add(directors.get(243));
        movies.get(252).getDirectors().add(directors.get(244));
        movies.get(253).getDirectors().add(directors.get(245));
        movies.get(254).getDirectors().add(directors.get(167));
